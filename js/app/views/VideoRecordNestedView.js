			...
			*/
			...
			bindEvents: function() {
				...
				_thisViewRecordVideoNested.$el.off('click','#captureVideoLinkPopup').on('click','#captureVideoLinkPopup',function(e){
					...
					$('#pageoverlay').append('<div style="width:'+($(window).width()-30)+'px;min-width:200px !important;max-width:650px !important;" data-role="popup" data-dismissible="true" data-overlay-theme="a" class="ui-corner-all" data-theme="b" id="'+popupid+'"></div>');
